...
with yfinance, and writes one compact JSON per ticker plus an index:
    ...
    webpage/research/stack/data/index.json     {updated, count, tickers:[{s,f,n,sec}]}
    webpage/research/stack/data/AAPL.json      {s, n, sec, updated, d:{...}, h1:{...}}
...
Usage:
    python automation/scripts/fetch_market_data.py --out webpage/research/stack/data
    python automation/scripts/fetch_market_data.py --out webpage/research/stack/data --limit 50 --daily-period 5y
    python automation/scripts/fetch_market_data.py --out webpage/research/stack/data --tickers AAPL MSFT NVDA
"""
...
def main() -> int:
    ...
    ap.add_argument("--out", default="webpage/research/stack/data", help="output folder (default: webpage/research/stack/data)")
