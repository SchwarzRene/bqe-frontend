...
with yfinance, and writes one compact JSON per ticker plus an index:
    ...
    stack/data/index.json     {updated, count, tickers:[{s,f,n,sec}]}
    stack/data/AAPL.json      {s, n, sec, updated, d:{...}, h1:{...}}
...
Usage:
    python scripts/fetch_market_data.py --out stack/data
    python scripts/fetch_market_data.py --out stack/data --limit 50 --daily-period 5y
...
def main() -> int:
    ...
    ap.add_argument("--out", default="stack/data", help="output folder (default: stack/data)")
