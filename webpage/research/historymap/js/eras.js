...
const ERAS = [
  {
    from: -9500, to: -1200,
    title: "Vorgeschichte & frühe Hochkulturen",
    ...
    text: "<p>Lange bevor es Reiche gibt, hinterlassen Menschen schon Kunst und Symbole: Höhlenmalereien wie in <b>Lascaux</b> (~17.000 v. Chr.) und Fruchtbarkeitsfigurinen wie die <b>Venus von Willendorf</b> zeugen vom reichen Ritualleben der letzten Eiszeitjäger – lange vor jeder Stadt oder Schrift. Die <b>Neolithische Revolution</b> (ab ~9500 v. Chr.) verändert dann alles: Menschen werden sesshaft, domestizieren Getreide und Tiere, bauen erste Tempel (<b>Göbekli Tepe</b>) und Städte (<b>Jericho</b>) – noch ohne Staat, aber schon mit Religion und Arbeitsteilung. Ab ~4500 v. Chr. entsteht in Westeuropa die <b>Megalithkultur</b>: monumentale Steinsetzungen wie Stonehenge, deren genauer Zweck bis heute rätselhaft ist.</p><p>An den großen Flüssen entstehen dann die ersten Staaten der Menschheit: Sumer erfindet um 3200 v. Chr. die Keilschrift, Ägypten eint sich unter den Pharaonen, im Industal blüht die Harappa-Kultur, in China entsteht die Shang-Dynastie. Königtum und Religion sind untrennbar – der Herrscher ist Gott oder Mittler der Götter.</p><p>Handel verbindet die Reiche: Zinn und Kupfer für Bronze müssen über weite Strecken beschafft werden. Diese Vernetzung macht die Welt reich – und verwundbar.</p>",
    ...
    kunst: "<p>Baustil: von unbehauenen Kultsteinen (Göbekli Tepe) über Lehmziegel-Stadtmauern zu den ersten Monumentalbauten der Geschichte. In Ägypten entwickelt sich die Pyramide vom Stufenbau zur glatten Vollpyramide von Gizeh; in Mesopotamien türmt sich die Zikkurat als „Treppe zu den Göttern“ auf. Skulptur dient fast ausschließlich dem Kult – überlebensgroße Pharaonenstatuen, sumerische Beterfiguren mit übergroßen, andächtigen Augen.</p>",
    koepfe: [
      "<b>Imhotep</b> – Baumeister der Djoser-Stufenpyramide, erster namentlich bekannter Architekt und Universalgelehrter der Geschichte.",
      "Anonyme Baumeister von Stonehenge und Göbekli Tepe – Monumentalbau existierte offenbar schon vor Schrift und Staat.",
      "Verfasser des <b>Gilgamesch-Epos</b> – die älteste große Literatur der Menschheit, Jahrhunderte vor Homer."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Griechische Vasenmalerei entwickelt sich vom geometrischen zum figürlichen Stil; erste Steintempel mit Holzsäulen-Vorläufern entstehen, Wegbereiter der späteren dorischen Ordnung. In Assyrien schmücken monumentale Palastreliefs mit geflügelten Stierwesen (Lamassu) die Torwege von Ninive und Nimrud – Kriegspropaganda in Stein, oft mit dramatischen Löwenjagdszenen.</p>",
    koepfe: [
      "<b>Homer</b> – Ilias und Odyssee werden zum kulturellen Grundtext der Griechen, obwohl seine historische Existenz umstritten ist.",
      "Assyrische Palastbildhauer – die Löwenjagd-Reliefs Assurbanipals gelten als Höhepunkt altorientalischer Kunst.",
      "Hebräische Propheten wie Jesaja – religiöse Dichtung, die das Judentum bis heute prägt."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Der <b>klassische Baustil</b> Griechenlands entsteht: dorische, ionische und bald korinthische Säulenordnung, vollendet im Parthenon auf der Akropolis. Bildhauer streben nach idealer Proportion des menschlichen Körpers (Kontrapost) statt starrer archaischer Frontalität. In Persien verschmelzen mit Persepolis ägyptische, mesopotamische und griechische Bautraditionen zu einer eigenen Palastarchitektur der Superlative.</p>",
    koepfe: [
      "<b>Phidias</b> – Bildhauer des Parthenon-Frieses und der Zeus-Statue von Olympia, eines der Sieben Weltwunder.",
      "<b>Sophokles</b> und <b>Euripides</b> – die griechische Tragödie erreicht mit „Ödipus“ und „Medea“ ihren Höhepunkt.",
      "<b>Herodot</b> – „Vater der Geschichtsschreibung“, bereist die bekannte Welt für seine Perserkriegs-Chronik."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Der Hellenismus bringt bewegtere, dramatischere Skulptur (Laokoon-Gruppe, Nike von Samothrake) und macht Alexandria zur Wissenschaftsstadt schlechthin. Rom übernimmt griechische Formensprache, entwickelt mit Bogen, Gewölbe und Beton (opus caementicium) aber eigene Bautechnik – die Grundlage für alle späteren Aquädukte und Kuppelbauten des Imperiums.</p>",
    koepfe: [
      "<b>Euklid</b> – seine „Elemente“ bleiben 2000 Jahre das Standardlehrbuch der Geometrie.",
      "<b>Archimedes</b> – Mathematiker und Ingenieur von Syrakus: Auftrieb, Hebelgesetz, Kriegsmaschinen.",
      "<b>Eratosthenes</b> – berechnet in Alexandria den Erdumfang mit erstaunlicher Genauigkeit."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Rom vollendet den Kuppelbau: das Pantheon bleibt bis zur Renaissance die größte freitragende Kuppel der Welt. Amphitheater wie das Kolosseum demonstrieren Ingenieurskunst und Machtinszenierung zugleich. In Han-China entwickelt sich die Kalligrafie zur eigenständigen Kunstform, Jade- und Bronzearbeiten erreichen hohe Perfektion.</p>",
    koepfe: [
      "<b>Vergil</b> – seine „Aeneis“ wird im Auftrag des Augustus zum römischen Nationalepos.",
      "<b>Ovid</b> – „Metamorphosen“ prägen die europäische Mythologie-Rezeption bis in die Neuzeit.",
      "<b>Seneca</b> und <b>Marc Aurel</b> – stoische Lebensphilosophie für Senator und Kaiser gleichermaßen."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Spätantike Kunst wird zunehmend religiös-symbolisch statt naturalistisch: frühchristliche Basiliken übernehmen die Form der römischen Gerichtshalle für den Gottesdienst. Mosaike in Ravenna zeigen den Übergang zum byzantinischen Stil – flächige, goldglänzende Bildsprache statt römischer Körperlichkeit.</p>",
    koepfe: [
      "<b>Augustinus</b> – „Confessiones“ gilt als erste große Autobiografie der Weltliteratur.",
      "<b>Hieronymus</b> – übersetzt die Bibel ins Lateinische (Vulgata), Grundlage der westlichen Kirche für 1000 Jahre.",
      "<b>Plotin</b> – Begründer des Neuplatonismus, verschmilzt Platon mit Mystik."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Byzanz vollendet mit der <b>Hagia Sophia</b> (Baumeister Anthemios von Tralleis und Isidor von Milet) den kühnsten Kuppelbau der Spätantike – Vorbild für Kirchen und Moscheen der folgenden 1000 Jahre. Der Islam entwickelt eine eigene Bildsprache ohne figürliche Darstellung: geometrische Ornamentik, Kalligrafie und der Moscheebau mit Minarett und Innenhof.</p>",
    koepfe: [
      "<b>Anthemios von Tralleis</b> und <b>Isidor von Milet</b> – Baumeister der Hagia Sophia, lösen ein bis dahin unlösbar scheinendes Kuppelproblem.",
      "<b>Beda Venerabilis</b> – englischer Mönch, gilt als „Vater der englischen Geschichtsschreibung“."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Die <b>karolingische Renaissance</b> bringt eine einheitliche Buchschrift (karolingische Minuskel – Vorbild unserer heutigen Kleinbuchstaben) und die Pfalzkapelle Aachen nach byzantinischem Vorbild. Bagdads Kalifenhof fördert Buchmalerei und kunstvolle Keramik; die Große Moschee von Samarra mit ihrem spiralförmigen Minarett wird zum Wahrzeichen abbasidischer Baukunst.</p>",
    koepfe: [
      "<b>Alkuin von York</b> – Gelehrter am Hof Karls des Großen, Motor der karolingischen Bildungsreform.",
      "<b>al-Chwarizmi</b> – begründet die Algebra in Bagdads Haus der Weisheit, sein Name wird zu „Algorithmus“.",
      "<b>al-Kindi</b> – „Philosoph der Araber“, vermittelt griechische Philosophie in die islamische Welt."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Der <b>romanische Baustil</b> prägt Europas Kirchen: dicke Mauern, Rundbögen, wehrhafte Klosteranlagen. Gegen Ende der Epoche entsteht in Frankreich die <b>Gotik</b> mit Spitzbogen, Strebewerk und farbigen Glasfenstern (Klosterkirche Saint-Denis, Kathedrale von Chartres) – Licht wird zum architektonischen Programm des Gottesbeweises.</p>",
    koepfe: [
      "<b>Abt Suger</b> von Saint-Denis – gilt als geistiger Vater der gotischen Architektur.",
      "<b>Hildegard von Bingen</b> – Universalgelehrte, Komponistin und Mystikerin, eine der ersten namentlich bekannten Künstlerinnen Europas.",
      "<b>Anselm von Canterbury</b> – Begründer der Scholastik: „Glauben, um zu verstehen“.",
      "<b>Omar Chayyam</b> – persischer Dichter und Mathematiker, berühmt für seine Vierzeiler (Rubaiyat)."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Gotische Kathedralen erreichen ihren Höhepunkt (Notre-Dame de Paris, Baubeginn Kölner Dom 1248). In China blüht unter der späten Song- und beginnenden Yuan-Zeit die Landschaftsmalerei mit Tusche – Naturdarstellung als philosophische Übung, nicht als Abbild. Persische Buchmalerei erlebt unter mongolischer Herrschaft eine erste Blüte.</p>",
    koepfe: [
      "<b>Thomas von Aquin</b> – „Summa theologiae“ versöhnt Aristoteles mit dem christlichen Glauben, Gipfel der Scholastik.",
      "<b>Rumi</b> – persischer Mystiker und Dichter, sein „Masnavi“ wird zu den meistgelesenen Gedichten der islamischen Welt.",
      "<b>Marco Polo</b> – sein Reisebericht über China wird zur wichtigsten europäischen Asien-Quelle des Mittelalters."
    ],
    konflikte: [
  ...
  },
  {
    ...
    denken: "Krisenzeit gebiert neues Denken: <b>Wilhelm von Ockham</b> trennt Glauben und Wissen („Ockhams Rasiermesser“), <b>Marsilius von Padua</b> denkt Herrschaft erstmals vom Volk her. In Italien beginnt mit <b>Petrarca</b> der <b>Humanismus</b>: der Mensch und die Antike statt Jenseitsfixierung – Vorbote der Renaissance. <b>Dante</b> schreibt die „Göttliche Komödie“ auf Italienisch statt Latein. Mystiker wie <b>Meister Eckhart</b> suchen Gott im Inneren. <b>Ibn Chaldun</b> (Tunis) begründet mit seiner Zyklen-Theorie der Reiche quasi die Soziologie.",
    kunst: "<p>Der Humanismus in Italien bereitet den Boden für die Renaissance: <b>Giotto di Bondone</b> bricht mit der starren byzantinischen Bildtradition und malt erstmals räumliche Tiefe und echte menschliche Gefühle. In der Baukunst dominiert weiter die spätgotische Flamboyant-Architektur, während Florenz mit seinem Dombau bereits den Übergang zur Renaissance vorbereitet.</p>",
    koepfe: [
      "<b>Giotto di Bondone</b> – gilt als Wegbereiter der europäischen Malerei der Neuzeit.",
      "<b>Dante Alighieri</b> – „Göttliche Komödie“ etabliert Italienisch als eigenständige Literatursprache.",
      "<b>Petrarca</b> – „Vater des Humanismus“, wiederentdeckt antike Texte und begründet die Idee der Renaissance.",
      "<b>Ibn Chaldun</b> – nordafrikanischer Gelehrter, begründet mit seiner Zyklentheorie der Reiche die Geschichtsphilosophie und Soziologie."
    ],
    konflikte: [
  ...
  },
  {
    ...
    denken: "Der Mensch rückt ins Zentrum: <b>Humanismus</b> (<b>Erasmus von Rotterdam</b>), Künstler werden Individuen statt anonyme Handwerker. <b>Machiavelli</b> („Der Fürst“, 1513) beschreibt Macht erstmals ohne Moral – schockierend ehrlich. <b>Kopernikus</b> (1543): Die Erde kreist um die Sonne – der Mensch verliert den Platz im Weltmittelpunkt. Luthers Kernideen: Gnade statt Werke, <b>die Bibel für alle</b> (seine Übersetzung formt die deutsche Sprache), das Gewissen des Einzelnen gegen Papst und Kaiser – gewaltiger Individualisierungsschub.",
    kunst: "<p>Die <b>Hochrenaissance</b> erreicht in Florenz und Rom ihren Gipfel: Zentralperspektive, anatomisch korrekte Körper, klassische Proportionen. <b>Brunelleschi</b>s Domkuppel in Florenz (1436) gilt als erstes Meisterwerk der neuen Baukunst, die sich an antiken Vorbildern statt an der Gotik orientiert. Michelangelos Sixtinische Kapelle und Raffaels „Schule von Athen“ definieren den klassischen Bildkanon Europas neu.</p>",
    koepfe: [
      "<b>Leonardo da Vinci</b> – Maler, Ingenieur, Anatom: Inbegriff des „Universalgenies“ der Renaissance.",
      "<b>Michelangelo</b> – Sixtinische Kapelle, David-Statue, Petersdom-Kuppel – kaum ein Künstler prägte mehr Gattungen zugleich.",
      "<b>Raffael</b> – vollendet mit der „Schule von Athen“ die klassische Bildkomposition der Hochrenaissance.",
      "<b>Albrecht Dürer</b> – bringt die italienische Renaissance-Kunst nach Deutschland, Meister des Kupferstichs."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Der <b>Barock</b> entsteht als Antwort der katholischen Gegenreformation: dramatische Lichteffekte, Bewegung, Pathos. In den calvinistischen Niederlanden blüht parallel eine bürgerliche Malkultur ohne kirchliche Auftraggeber – Porträt, Landschaft und Alltagsszene werden zum Marktprodukt für private Käufer statt zum Kirchenschmuck.</p>",
    koepfe: [
      "<b>Caravaggio</b> – revolutioniert die Malerei mit radikalem Hell-Dunkel (Chiaroscuro) und schonungslosem Realismus.",
      "<b>El Greco</b> – manieristische Heiligenbilder in Toledo, expressiv verzerrte Figuren.",
      "<b>William Shakespeare</b> – prägt mit seinen Tragödien und Komödien die englische Sprache wie kein anderer Autor.",
      "<b>Miguel de Cervantes</b> – „Don Quijote“ gilt als erster moderner Roman Europas.",
      "<b>Rembrandt</b> – meistert wie kein anderer Licht, Schatten und die menschliche Psyche im Porträt."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Der <b>Barock</b> wird zum Herrschaftsstil schlechthin: <b>Versailles</b> inszeniert absolute Macht durch Symmetrie, Weite und Prunk – jedes europäische Fürstenhaus baut fortan sein eigenes „Klein-Versailles“. In der Malerei dominiert das offizielle Herrscherporträt, in der Musik entsteht am Hof Ludwigs XIV. mit Lully die höfische französische Oper.</p>",
    koepfe: [
      "<b>André Le Nôtre</b> – Gartenarchitekt von Versailles, erfindet den geometrischen „französischen Garten“.",
      "<b>Jean-Baptiste Lully</b> – Hofkomponist Ludwigs XIV., begründet die französische Barockoper.",
      "<b>Christopher Wren</b> – baut nach dem großen Brand von London die St.-Pauls-Kathedrale neu."
    ],
    konflikte: [
  ...
  },
  {
    ...
    denken: "„<b>Habe Mut, dich deines eigenen Verstandes zu bedienen!</b>“ (<b>Immanuel Kant</b>, 1784). <b>Montesquieu</b> fordert Gewaltenteilung, <b>Rousseau</b> Volkssouveränität („Der Mensch ist frei geboren, und überall liegt er in Ketten“), <b>Voltaire</b> Toleranz und Meinungsfreiheit, <b>Beccaria</b> das Ende von Folter und Todesstrafe, <b>Adam Smith</b> (1776) den freien Markt. Diese Bücher sind das Betriebssystem der modernen Demokratien. Grenzen der Epoche: Sklaverei blüht im Atlantikhandel wie nie – die Widersprüche zwischen Ideal und Praxis werden zum Sprengstoff.",
    kunst: "<p>Auf den schweren Barock folgt das leichtere, verspielte <b>Rokoko</b> (Schloss Sanssouci) – dann, als Gegenbewegung zur höfischen Verspieltheit, der nüchterne <b>Klassizismus</b>, der sich an griechisch-römischer Strenge orientiert (Brandenburger Tor, Baubeginn 1788). In der Musik reift mit Bach, Haydn und dem jungen Mozart die Wiener Klassik.</p>",
    koepfe: [
      "<b>Johann Sebastian Bach</b> – vollendet die barocke Musik mit kontrapunktischer Meisterschaft.",
      "<b>Wolfgang Amadeus Mozart</b> – Wunderkind und Klassik-Komponist, prägt Oper und Symphonie bis heute.",
      "<b>Immanuel Kant</b> – „Kritik der reinen Vernunft“ wird zum Fundament moderner Philosophie.",
      "<b>Denis Diderot</b> – Herausgeber der Encyclopédie, sammelt das Wissen der Aufklärung in einem Mammutwerk.",
      "<b>Antonio Canova</b> – klassizistische Skulptur auf der Höhe ihrer kühlen Eleganz."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Die Kunst wird politisch: <b>Jacques-Louis David</b> malt zunächst revolutionäres Pathos, dann Napoleon-Propaganda als dessen Hofmaler. Architektonisch setzt sich der <b>Klassizismus</b> als „Reichsstil“ des napoleonischen Empire durch (Triumphbogen von Paris) – als Gegenbewegung entsteht zeitgleich die gefühlsbetonte <b>Romantik</b> in Malerei und Dichtung.</p>",
    koepfe: [
      "<b>Jacques-Louis David</b> – vom Revolutionsmaler zum offiziellen Hofmaler Napoleons.",
      "<b>Francisco de Goya</b> – dokumentiert mit „Die Erschießung der Aufständischen“ die Schrecken des Krieges schonungslos.",
      "<b>Johann Wolfgang von Goethe</b> – „Faust“ wird zum Schlüsselwerk der deutschen Literatur zwischen Aufklärung und Romantik.",
      "<b>Ludwig van Beethoven</b> – bricht mit der Klassik und öffnet der Musik den Weg in die Romantik."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Die <b>Romantik</b> feiert Gefühl, Natur und Nationalgeschichte; als Antwort auf Industrialisierung und soziale Not entsteht der <b>Realismus</b>, der Arbeiter und Elend ungeschönt zeigt. Architektonisch grassiert der Historismus – Neugotik (Vollendung des Kölner Doms 1880) und Neorenaissance kopieren vergangene Stile für neue bürgerliche und staatliche Prachtbauten.</p>",
    koepfe: [
      "<b>Caspar David Friedrich</b> – deutsche Romantik pur: der einsame Mensch vor erhabener Natur.",
      "<b>Eugène Delacroix</b> – „Die Freiheit führt das Volk“ wird zur Bildikone der Revolution.",
      "<b>Charles Dickens</b> – schildert das soziale Elend der Industrialisierung wie kein anderer Autor.",
      "<b>Karl Marx</b> – „Das Kapital“ liefert die theoretische Grundlage der sozialistischen Bewegung.",
      "<b>Richard Wagner</b> – revolutioniert die Oper zum „Gesamtkunstwerk“."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Aus dem Historismus lösen sich die Avantgarden: der <b>Impressionismus</b> fängt Licht und Moment ein, danach zersplittert die Kunst in Expressionismus und beginnenden Kubismus. Architektonisch ermöglichen Stahl und Glas völlig neue Bauformen – der Eiffelturm (1889) und erste Wolkenkratzer in Chicago demonstrieren die neue Technik. Der <b>Jugendstil</b> sucht organische Formen als Gegenentwurf zur nüchternen Industrieästhetik.</p>",
    koepfe: [
      "<b>Claude Monet</b> – Namensgeber des Impressionismus, malt Licht statt feste Gegenstände.",
      "<b>Vincent van Gogh</b> – expressive Farbgewalt, zu Lebzeiten fast unverkauft, posthum einer der teuersten Maler der Welt.",
      "<b>Antoni Gaudí</b> – Sagrada Família: Jugendstil-Architektur an der Grenze zur Fantasie.",
      "<b>Gustav Klimt</b> – Wiener Jugendstil, „Der Kuss“ wird zur Ikone.",
      "<b>Friedrich Nietzsche</b> und <b>Sigmund Freud</b> – erschüttern das rationale Selbstbild des modernen Menschen."
    ],
    konflikte: [
  ...
  },
  {
    ...
    denken: "Der Fortschrittsglaube stirbt in den Schützengräben. <b>Totalitäre Ideologien</b> versprechen Erlösung: Kommunismus (klassenlose Gesellschaft – Preis: Terror, Gulag, Hungersnöte), Faschismus/Nationalsozialismus (Volk, Führer, Rasse – Preis: Krieg und Völkermord). Demokratien wirken schwach und entschlusslos (Appeasement). Kulturell: „Goldene Zwanziger“ (Jazz, Bauhaus, Kino), Existenzphilosophie (<b>Martin Heidegger</b>, später Sartre), Quantenphysik zerlegt die Gewissheiten. Nach 1945: „Nie wieder“ – Vereinte Nationen, Menschenrechtserklärung (1948), Nürnberger Prozesse begründen das Völkerstrafrecht.",
    kunst: "<p>Der Schock des Ersten Weltkriegs zersplittert die Kunst endgültig: <b>Dada</b> verhöhnt jede Ordnung, der Surrealismus erforscht das Unbewusste, das <b>Bauhaus</b> verschmilzt Architektur, Design und Funktion zu radikaler Klarheit. Die NS-Diktatur bekämpft diese Moderne als „entartete Kunst“ und verordnet stattdessen monumentalen, klassizistisch verbrämten Machtstil.</p>",
    koepfe: [
      "<b>Walter Gropius</b> – gründet das Bauhaus, die einflussreichste Design- und Architekturschule des 20. Jahrhunderts.",
      "<b>Pablo Picasso</b> – „Guernica“ wird zum berühmtesten Antikriegsbild der Kunstgeschichte.",
      "<b>Salvador Dalí</b> – surrealistische Traumwelten, zerfließende Uhren als Sinnbild relativer Zeit.",
      "<b>Ernest Hemingway</b> – die „verlorene Generation“ verarbeitet das Kriegstrauma literarisch.",
      "<b>Martin Heidegger</b> – „Sein und Zeit“ prägt die Existenzphilosophie, seine NS-Verstrickung überschattet sein Werk bis heute."
    ],
    konflikte: [
  ...
  },
  {
    ...
    denken: "Angst und Aufbruch: <b>Existenzialismus</b> (<b>Jean-Paul Sartre</b>, <b>Albert Camus</b> – der Mensch ist zur Freiheit verurteilt), Anti-Atom- und Friedensbewegung, ab den 60ern die große Kulturrevolte: <b>Bürgerrechtsbewegung</b> (Martin Luther King: „I have a dream“, 1963), Studentenproteste 1968, zweite Welle des <b>Feminismus</b>, Beginn der <b>Umweltbewegung</b> (1972 „Grenzen des Wachstums“). Konsumgesellschaft, Fernsehen und Popkultur (<b>The Beatles</b>!) verändern den Alltag radikaler als jede Ideologie. Am Ende siegt kein Denker, sondern die Attraktivität von Wohlstand und Freiheit – und Gorbatschows Einsicht, dass das sowjetische System nicht reformierbar ist (Glasnost, Perestroika).",
    kunst: "<p>New York löst Paris als Kunstzentrum ab: abstrakter Expressionismus und später <b>Pop-Art</b> machen die Konsumkultur selbst zum Bildmotiv. Architektonisch dominiert die klassische Moderne mit Stahl-Glas-Türmen weltweit die Innenstädte – „Form follows function“ wird globaler Standard, ehe die Postmoderne ab den 1970ern wieder Ornament und Ironie zulässt.</p>",
    koepfe: [
      "<b>Andy Warhol</b> – Pop-Art macht Campbell-Suppendosen und Marilyn Monroe zur Hochkunst.",
      "<b>Jackson Pollock</b> – von der Figur zur reinen Aktion auf der Leinwand.",
      "<b>Ludwig Mies van der Rohe</b> – „Weniger ist mehr“ prägt die Wolkenkratzer-Ästhetik der Nachkriegszeit.",
      "<b>Jean-Paul Sartre</b> und <b>Albert Camus</b> – Existenzialismus als Lebensphilosophie einer verunsicherten Nachkriegsgeneration.",
      "<b>The Beatles</b> – verändern Popmusik und Jugendkultur weltweit."
    ],
    konflikte: [
  ...
  },
  {
    ...
    kunst: "<p>Kunst wird global und digital: Biennalen und Kunstmessen vernetzen Künstler aus aller Welt, <b>Streetart</b> erobert den öffentlichen Raum, digitale Medien stellen den klassischen Kunstbegriff infrage. In der Architektur ermöglicht computergestütztes Design spektakuläre „Ikonenbauten“ als Stadtmarketing – der „Bilbao-Effekt“, benannt nach Frank Gehrys Guggenheim-Museum.</p>",
    koepfe: [
      "<b>Frank Gehry</b> – das Guggenheim-Museum Bilbao macht dekonstruktivistische Architektur weltberühmt.",
      "<b>Zaha Hadid</b> – erste Frau mit dem Pritzker-Preis, fließende, computergenerierte Bauformen.",
      "<b>Banksy</b> – anonyme Streetart wird zur globalen Marke und politischen Stimme zugleich.",
      "<b>Ai Weiwei</b> – chinesischer Künstler und Regimekritiker, verbindet Kunst und Menschenrechtsaktivismus."
    ],
    konflikte: [
